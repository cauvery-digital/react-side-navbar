...
const Home = () => {
  // useState for if else conditions
 //const [navOpen, setNavOpen] = useState(true);
  /*  {navOpen? "container" : "container-nav"  */
  // onSidebarclose function passed in Sidebar.jsx 
  // to change the class of the main container to "container-nav" 
